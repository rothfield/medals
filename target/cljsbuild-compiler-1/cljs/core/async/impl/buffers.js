...
var v_19587 = this$.pop();
if(cljs.core.truth_((function (){var G__19586 = v_19587;
return (keep_QMARK_.cljs$core$IFn$_invoke$arity$1 ? keep_QMARK_.cljs$core$IFn$_invoke$arity$1(G__19586) : keep_QMARK_.call(null,G__19586));
})())){
this$.unshift(v_19587);
} else {
}
...
return cljs.core._write(writer__4915__auto__,"cljs.core.async.impl.buffers/RingBuffer");
});
...
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str("Can't add to a full buffer"),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(new cljs.core.Symbol(null,"not","not",1044554643,null),cljs.core.list(new cljs.core.Symbol("impl","full?","impl/full?",-97582774,null),new cljs.core.Symbol(null,"this","this",1028897902,null)))], 0)))].join('')));
}
...
return cljs.core._write(writer__4915__auto__,"cljs.core.async.impl.buffers/FixedBuffer");
});
...
return cljs.core._write(writer__4915__auto__,"cljs.core.async.impl.buffers/DroppingBuffer");
});
...
return cljs.core._write(writer__4915__auto__,"cljs.core.async.impl.buffers/SlidingBuffer");
});
